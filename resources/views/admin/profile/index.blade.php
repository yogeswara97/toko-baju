<x-admin.layout.layout>
    ...
    <x-admin.layout.header title="Profile" :breadcrumbs="[
        ['label' => 'Profile'],
    ]" />
    <section class="">
            ...
            <div class="w-full lg:w-1/3 space-y-6">
                ...
                <div class=" border border-gray-200 rounded-xl p-6">
                    <div class="flex justify-center mb-4">
                        @php
                        $image = auth()->user()->image ? asset(auth()->user()->image) :
                        asset('assets/static-images/no-image.jpg');
                        @endphp
                ...
                <div class=" border border-gray-200 rounded-xl p-6">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <a href="{{ route('customer.address.create') }}"
                            class="bg-admin-primary text-white px-4 py-2 rounded hover:bg-admin-primary text-sm transition">
                            + Tambah Alamat
                        </a>
                    </div>
                    ...
                    <ul class="space-y-6">
                        ...
                        <li class="border-t border-gray-200 pt-4 flex justify-between items-start">
                            <div class="text-sm text-gray-800 space-y-1">
                                ...
                                <p>Total: <span class="text-green-600 font-bold">
